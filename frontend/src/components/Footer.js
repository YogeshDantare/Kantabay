                ...
                <Col>
                    ...
                    <Row>
                        <div className="text-center">
                            <span>Yogesh Mohan Dantare:</span> 
                            <Link to={{ pathname: "https://github.com/YogeshDantare" }} target="_blank">
                                <i className="fab fa-github social-media-icon"></i>
                            </Link>
                            <Link to={{ pathname: "https://www.linkedin.com/in/yogesh-mohan-dantare-67205a17a/"}} target="_blank">
